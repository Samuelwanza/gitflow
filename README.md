...
# 📖 [Gitflow] <a name="about-project"></a>

**[GitFlow]** is a project that aims to utilize gitflow in version control by having dev branch as the default branch instead of main branch
